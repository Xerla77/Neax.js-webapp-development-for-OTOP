        ...
        >
          <div className="navbar-nav w-100">
            <div className="nav-item dropdown dropright">
              <button
                className="nav-link dropdown-toggle btn btn-link text-start w-100"
                onClick={() => setDropdownOpen(!dropdownOpen)}
                style={{ textDecoration: 'none' }}
              >
                สมุนไพร <i className="fa fa-angle-right float-right mt-1" />
              </button>
              {dropdownOpen && (
                <div className="dropdown-menu position-static rounded-0 border-0 m-0 show">
            ...
            {[
              ...
              <Link key={item} href="#" className="nav-item nav-link">
                {item}
              </Link>
            ))}
          </div>
              ...
              <nav className="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                ...
                >
                  <div className="navbar-nav mr-auto py-0">
                    ...
                    <a href="/contack" className="nav-item nav-link">
                      ติดต่อ
                    </a>
